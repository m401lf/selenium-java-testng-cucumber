...
public class getLocation_W {
	  ...
	  public void findElements() throws Exception {
	    ...
	    System.out.println("X-Coordinate List_Scream Login_Portal_Test_Page button : "+X_Coordinate);
	//------------------------------------------------------------------------------//
	    int Y_Coordinate = Login_Button.getLocation().y;
	    System.out.println("Y-Coordinate List_Scream Login_Portal_Test_Page button : "+Y_Coordinate);
	//------------------------------------------------------------------------------//
	    Thread.sleep(3000);
	  	}
