...
public class Video_45_deSelectByIndextCommand {
    ...
    public void f1() throws Exception {
        ...
        // The purpose deselectByIndex() command is used to unselect the selected value from MultiSelect webElement from the webPage
