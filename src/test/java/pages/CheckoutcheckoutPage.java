...
public class CheckoutcheckoutPage extends BasePage {

    final static Logger log = LogManager.getLogger(CheckoutcheckoutPage.class);
    WebDriver driver;
    LoginPage loginPage;
    ...
    public CheckoutcheckoutPage(WebDriver driver) {
        super(driver);
        this.driver = driver;
