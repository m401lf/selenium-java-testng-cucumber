...
public class ExcelUtilityLib {
    ...
    public static void setExcelFile(String path, String sheetName) {
        try {
            ...
            // Access the excel testData.data sheet
    ...
    public static String[][] getTestData(String tableName) {
        ...
        try {
            ...
            // We need to find first and last column, so that we know which rows to read for the testData.data
            XSSFCell[] boundaryCells = findTableNameCells(tableName);
            // First cell to start with
            XSSFCell startCell = boundaryCells[0];
            // Last cell where testData.data reading should stop
            ...
            // Declare multi-dimensional array to capture the testData.data from the table
